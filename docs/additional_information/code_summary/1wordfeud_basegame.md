...
* If you play against Chance or Combi, a dictionary is created which takes all seven-, six- and five-letter words in the wordlist as the value and the letters of the word in alphabetical order as the key for rapid lookup operations.
