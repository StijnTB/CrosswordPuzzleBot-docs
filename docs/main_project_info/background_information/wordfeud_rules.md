...
Wordfeud is a relatively simple game and shares most of its rules with Scrabble.
...
* There are a few options for the end of the game:
    * Both the tilebag and the tilerow of one of the players is empty. The player who has the empty tilerow receives the total value of the opponent's tilerow as a bonus. The same value is subtracted from the opponent's score
    ...
    * The winner is the player with the highest amount of points at the end of the game.